...
urlpatterns = [
    ...
    path("buy/session/<int:pk>", StripeSessionItemView.as_view(), name="create_session_item"),
    path('buy/intent/<pk>/', StripeIntentItemView.as_view(), name='create_payment_intent_item'),
